                    ...
                    <div class="tab-pane fade show active" id="custom-tabs-two-details" role="tabpanel" aria-labelledby="custom-tabs-two-details-tab">
                     ...
                     <form id="reportIncidentForm">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <select name="client" class="custom-select" id="client" style="width: 100%;">
                      ...
                      <div class="form-group row mb-5">
                        ...
                        <div class="col-sm-10">
                          <select name="priority" class="custom-select" id="priority" style="width: 100%;">
                      ...
                      <div class="form-group row">
                        <label for="reportedBy" class="col-sm-2 col-form-label">Reported By</label>
                        <div class="col-sm-10">
                          <input type="text" name="reportedBy" class="form-control" id="reportedBy" placeholder="Reported By">
                        </div>
                      </div>
                  ...
                  <div class="tab-pane fade" id="custom-tabs-two-assign" role="tabpanel" aria-labelledby="custom-tabs-two-assign-tab">
                   <form id="assignIncidentForm">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <select name="assignTo" class="custom-select" id="assignTo" style="width: 100%;">
